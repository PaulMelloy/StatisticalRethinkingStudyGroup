...
*We can see that where the top card is black and the bottom side is black occurs 2 times out of the 6 equally likely options.*
...
$Pr(twins) = Pr(twins|PandaSpecies_A)*Pr(PandaSpecies_A) + Pr(twins|PandaSpecies_B)*Pr(PandaSpecies_A)$
